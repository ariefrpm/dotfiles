...
require("lazy").setup({
	...
	require("custom.plugins.lspconfig"), -- adds gitsigns recommend keymaps
	require("custom.plugins.autocompletion"), -- adds gitsigns recommend keymaps
	require("custom.plugins.telescope"), -- adds gitsigns recommend keymaps
